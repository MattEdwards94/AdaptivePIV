...
class TestCorrWindow(unittest.TestCase):
    ...
    def test_u_and_v_are_init_to_none(self):
        """
        ...
        self.assertTrue(cw.u is None)
        self.assertTrue(cw.v is None)

    def test_u_and_v_pre_validation_are_initialised_to_none(self):
        """
        ...
        self.assertTrue(cw.u_pre_validation is None)
        self.assertTrue(cw.v_pre_validation is None)

    def test_flag_initialised_to_none(self):
        """
        ...
        self.assertTrue(cw.flag is None)
